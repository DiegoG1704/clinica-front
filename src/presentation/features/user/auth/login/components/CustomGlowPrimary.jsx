    ...
    >
      ...
      <g mask="url(#mask0_6188_177318)">
        <g filter="url(#filter0_f_6188_177318)">
          <ellipse
            cx="64.58" // antes: 54.58
            cy="65.67" // antes: 55.67
            rx="64.58" // antes: 54.58
            ry="65.67" // antes: 55.67
            transform="matrix(-0.999052 0.0435305 0.041825 0.999125 267.735 392.531)"
            fill="#16617c"
          />
          <ellipse
            cx="80.36" // antes: 70.36
            cy="81.77"
            rx="80.36"
            ry="81.77"
