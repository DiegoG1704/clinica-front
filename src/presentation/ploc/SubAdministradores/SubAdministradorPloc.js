...
export class SubAdminPloc extends Ploc {
    constructor(getAllSubAdmin, createSubAdmin, updateSubAdmin, deleteSubAdmin) {
        super(localesInitialState);
        this.getAllSubAdminUseCas=getAllSubAdmin;
        this.createSubLocalUseCase=createSubAdmin;
        this.updateSubAdmin=updateSubAdmin;
