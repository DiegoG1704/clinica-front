...
const TerminosCondiciones = () => {
    return (
        <div className="terms-container">
            ...
            <p class="paragraph">
                El presente documento es celebrado por <strong>ADB CONSULTING S.A.C</strong>, con RUC N° 20524589571 representante del <strong>“MAS SALUD”</strong>
                quien en adelante se DENOMINARÁ EL PROGRAMA, y de la otra parte el afiliador quien en adelante se llamará <strong>EL PROMOTOR</strong>,
            ...
            <p className="paragraph">
                ...
                Los <strong>PROMOTORES </strong> no podrán usar los logos o materiales del Programa <strong>MAS SALUD</strong>, ya que se encuentra registrado.
                El Programa <strong>MAS SALUD </strong>podrá comercializar materiales de Merchandising para uso de los PROMOTORES, USUARIOS o instituciones prestadoras de salud ,que así lo requieran.

            </p>

            <h2 class="section-title">SOBRE LA PROTECCIÓN DE PROPIEDAD INTELECTUAL</h2>
            <p class="paragraph">
                La inclusión de esta cláusula está respaldada por la <strong>Ley de Derecho de Autor (Ley N.º 822)</strong> y la normativa de propiedad intelectual en el Perú.
            </p>
            <h2 class="section-title">SOBRE LA CLÁUSULA DE EXCLUSIÓN DE DERECHOS ADQUIRIDOS:</h2>
            <p class="paragraph">
                SOBRE LA CLÁUSULA DE EXCLUSIÓN DE DERECHOS ADQUIRIDOS:Aunque la
                anulación de derechos adquiridos es válida, debe estar claramente delimitada
                para evitar conflictos legales. Por ejemplo, si las compensaciones económicas
            ...
            <p className="paragraph">
                ...
                En señal de conformidad, firmo los presentes <strong>Terminos Y Condiciones</strong> en calidad de declaración jurada en la ciudad de LIMA  día….. del mes ………… del año…….
