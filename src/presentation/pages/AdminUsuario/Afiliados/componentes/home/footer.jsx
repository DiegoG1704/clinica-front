...
const quickLinks = [
    ...
    { name: 'Sobre Nosotros', href: '/about', icon: 'pi pi-info-circle' },
    { name: 'Servicios', href: '/services', icon: 'pi pi-briefcase' },
    { name: 'Blog', href: '/blog', icon: 'pi pi-book' },
    { name: 'Contacto', href: '/contact', icon: 'pi pi-envelope' },
];
...
const socialLinks = [
    {
        name: 'YouTube',
        url: 'https://youtube.com/@massalud',
        icon: 'pi pi-youtube',
        ariaLabel: 'Visita nuestro canal de YouTube'
    },
    {
        name: 'Instagram',
        url: 'https://instagram.com/massalud',
